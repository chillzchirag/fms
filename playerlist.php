...
<html lang="en">
  ...
  <?php   
    ...
    $c='A';
    for( $j=1;$j<=26;$j++)  {
      echo '<a href="playerlist.php?p='.$c.'"><u>'.$c.'</u>&nbsp;&nbsp;</a>';
      $c++;
    } ?>
	<a href="playersearch.php?pos=GOALKEEPER&rating=80"><button class="btn btn-lg btn-success btn-block">Custom Search</button></a><br>
    </center><br><br>
